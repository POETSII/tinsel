...
add_interface_port avalon_master_1 dramIfcs_0_m_address address Output 30
add_interface_port avalon_master_1 dramIfcs_0_m_burstcount burstcount Output 1
add_interface_port avalon_master_1 dramIfcs_0_m_read read Output 1
add_interface_port avalon_master_1 dramIfcs_0_m_readdata readdata Input 256
add_interface_port avalon_master_1 dramIfcs_0_m_readdatavalid readdatavalid Input 1
add_interface_port avalon_master_1 dramIfcs_0_m_waitrequest waitrequest Input 1
add_interface_port avalon_master_1 dramIfcs_0_m_write write Output 1
add_interface_port avalon_master_1 dramIfcs_0_m_writedata writedata Output 256
...
add_interface_port avalon_master_2 dramIfcs_1_m_readdata readdata Input 256
add_interface_port avalon_master_2 dramIfcs_1_m_readdatavalid readdatavalid Input 1
add_interface_port avalon_master_2 dramIfcs_1_m_waitrequest waitrequest Input 1
add_interface_port avalon_master_2 dramIfcs_1_m_writedata writedata Output 256
add_interface_port avalon_master_2 dramIfcs_1_m_address address Output 30
add_interface_port avalon_master_2 dramIfcs_1_m_read read Output 1
add_interface_port avalon_master_2 dramIfcs_1_m_write write Output 1
add_interface_port avalon_master_2 dramIfcs_1_m_burstcount burstcount Output 1
...
# 
# connection point transmitifc_source
# 
add_interface transmitifc_source avalon_streaming start
set_interface_property transmitifc_source associatedClock clock
set_interface_property transmitifc_source associatedReset reset_sink
set_interface_property transmitifc_source dataBitsPerSymbol 8
set_interface_property transmitifc_source errorDescriptor ""
set_interface_property transmitifc_source firstSymbolInHighOrderBits true
set_interface_property transmitifc_source maxChannel 0
set_interface_property transmitifc_source readyLatency 0
set_interface_property transmitifc_source ENABLED true
set_interface_property transmitifc_source EXPORT_OF ""
set_interface_property transmitifc_source PORT_NAME_MAP ""
set_interface_property transmitifc_source CMSIS_SVD_VARIABLES ""
set_interface_property transmitifc_source SVD_ADDRESS_GROUP ""

add_interface_port transmitifc_source transmitIfc_source_endofpacket endofpacket Output 1
add_interface_port transmitifc_source transmitIfc_source_data data Output 64
add_interface_port transmitifc_source transmitIfc_source_source_ready ready Input 1
add_interface_port transmitifc_source transmitIfc_source_startofpacket startofpacket Output 1
add_interface_port transmitifc_source transmitIfc_source_valid valid Output 1
...
add_interface_port avalon_streaming_sink receiveIfc_sink_ready ready Output 1
add_interface_port avalon_streaming_sink receiveIfc_sink_sink_data data Input 64
add_interface_port avalon_streaming_sink receiveIfc_sink_sink_valid valid Input 1
add_interface_port avalon_streaming_sink receiveIfc_sink_sink_startofpacket startofpacket Input 1
add_interface_port avalon_streaming_sink receiveIfc_sink_sink_endofpacket endofpacket Input 1
