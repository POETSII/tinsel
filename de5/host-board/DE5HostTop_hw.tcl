...
add_interface_port mac_source mac_source_empty empty Output 3
add_interface_port mac_source mac_source_error error Output 1
...
add_interface_port mac_sink mac_sink_sink_empty empty Input 3
