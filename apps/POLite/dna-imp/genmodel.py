...
for no_states in range(10, run_max, run_step):
    ...
    with open('model.cpp', "w") as f:
        ...
        f.write('const uint32_t observation[NOOFOBS] = { ')
        ...
        f.write('const float init_prob[NOOFSTATES] = { ')
        ...
        f.write('const float trans_prob[NOOFSTATES][NOOFSTATES] = {\n')
        ...
        f.write('const float emis_prob[NOOFSTATES][NOOFSYM] = {\n')
        for dim1 in range(0, no_states):
            f.write('    { ')
    ...
    with open('model.h', "w") as f:
        ...
        f.write(' * ************************************************/\n')
        f.write('\n')
        f.write('extern const uint32_t observation[NOOFOBS];\n')
        f.write('extern const float init_prob[NOOFSTATES];\n')
        f.write('extern const float trans_prob[NOOFSTATES][NOOFSTATES];\n')
        f.write('extern const float emis_prob[NOOFSTATES][NOOFSYM];\n')
        f.write('\n')
        f.write('#endif\n')
        f.write('\n')
