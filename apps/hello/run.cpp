...
int main()
{
  ...
  // // just send  message to each core.
  // for (int i=0; i<5000; i++) {
  //   // hostLink.flushcore(hostLink.toAddr(0, 0, 0, 0));
  //   hostLink.checkbyte(hostLink.toAddr(1, 0, 0, 0), 'd');
  // }

  // hostLink.printStack( 0, 0, 0 );
  // hostLink.printStack( 1, 0, 0 );
  ...
  // while (1) {
    ...
    //   for (int y=0; y<1; y++) {
    //     for (int i=0; i<8; i++) {
    //       printf("[run.cpp]: checking %i %i %i.\n", x, y, i);
    //       hostLink.checkbyte(hostLink.toAddr(x, y, i, 0), 'd');
    //     }
    //   }
    // }
  // }
  ...
  // hostLink.loadOne("code.v", "data.v", 0, 0, 5);
  ...
  // hostLink.goOne(1, 0, 5);
  // hostLink.goOne(0, 0, 1);
  // hostLink.startOne(1, 0, 5, 1);
