...
// This module provides 4GB of RAM to BlueSim for simulating
// DRAM/SRAM.  It divides the 4GB into 1M x 4KB pages, and allocates
// pages on demand.  The initial contents is all zeroes.  It provides
// functions to read and write 32-bit words.
...
#define MAX_RAMS_PER_BOARD 8

// Globals
uint32_t** ram[MAX_RAMS_PER_BOARD] =
...
{
  int i;
  assert(ramId < MAX_RAMS_PER_BOARD);
