# Tinsel Architecture and API Guide
...
Tinsel implements all instructions in the RV32IMF profile, except for
the following:
...
instruction is provided for accessing CSRs.  We provide a
[script](/bin/checkelf.sh) to
...
result inerhit a number of limitations:
